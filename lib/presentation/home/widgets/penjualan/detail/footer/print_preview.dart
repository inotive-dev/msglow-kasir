  ...
  Widget _buildClosingResponsePreview(ClosingResponse? closingResponse) {
    ...
    return Column(
      ...
      children: [
        ...
        Column(
          children: _cashManagementDetail.incomeCashManagementDetail!.map<Widget>((income) {
            return ArgsContainer(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  MyText(text: income.text ?? ''),
        ...
        ArgsContainer(
          child: Row(
            ...
            children: [
              ...
              _cashManagementDetail.expense!.isEmpty ? MyText(text: formatToIdr(0)) : Container()
            ],
          ),
        ),
        Column(
        ...
        ArgsContainer(
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const MyText(text: "Expected Ending Cash"),
              MyText(text: formatToIdr(_cashManagementDetail.expectedEndingCash)),
            ],
          ),
        ),
        ArgsContainer(
